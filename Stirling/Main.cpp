...
#define SIMPLE_VERT "shaders/simpleshader.vert"
#define SIMPLE_FRAG "shaders/simpleshader.frag"
...
int main() {
    ...
    Drawable* tri = new Drawable(shaderProg, GL_TRIANGLES);
    ...
    tri->loadLayoutBuffer(verts, 3);
    tri->initLayout(2);

    engine.addAsset(tri);

    cout << "starting engin" << endl;
    engine.start();
}
